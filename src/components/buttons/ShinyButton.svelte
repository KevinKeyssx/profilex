...
<button class="button" on:click={onClick} { disabled }>
    ...
    <span class="text_button">{title}</span>
</button>
...
<style>
    ...
    .button:not([disabled]):is(:hover, :focus) .sparkle .path {
