            ...
            <div class="p-6 flex-1 flex flex-col">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div class="relative flex items-center">
                        <span class="relative inline-flex h-2 w-2 rounded-full {project.status === 'In Dev' ? 'bg-yellow-500' : 'bg-green-500'}">
                            <span class="animate-pulse-slow absolute inline-flex h-full w-full rounded-full {project.status === 'In Dev' ? 'bg-yellow-400' : 'bg-green-400'} opacity-75"></span>
                        </span>
                        <!-- <span class="ml-1.5 text-xs {project.status === 'In Dev' ? 'text-yellow-400' : 'text-green-400'}">{project.status}</span> -->
                    </div>
                </div>
